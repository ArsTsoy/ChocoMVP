...
public class GetDealIntractorImpl {


//    @Override
//    public void getDealsList(final OnFinishedListener onFinishedListener, int town_id, int category_id, String sort_by, int page) {
